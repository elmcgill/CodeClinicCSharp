...
namespace Tests_WeatherData
{
    ...
    {
        private static string filename = @"D:\Documents\Projects\CodeClinicCSharp\data\Environmental_Data_Deep_Moor_2012.txt";
...
2012_01_01 00:21:00	33.80	30.60	27.30	76.60	280.80	17.00	14.00";
        ...
        public void Test_060_FitLineToFilteredSampleFile()
        {
            ...
            using (var text = new StreamReader(filename))
            {
                ...
                Tuple<double, double> intslope;

                intslope = MathNet.Numerics.Fit.Line(arrX.ToArray(), arrY.ToArray());

                Check.That(intslope.Item2).IsLessThan(0);
            }
        }
    }
}